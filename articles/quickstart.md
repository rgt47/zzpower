...
**zzpower** is an interactive Shiny application for power analysis and
sample size calculations in clinical trials. The package supports
multiple statistical tests through a scalable plugin architecture.
...
The application opens in your web browser with a tabbed interface for
...
- Effect size methods: Cohen’s d, percent reduction, difference in
  scores
...
- Effect size methods: two proportions, difference, odds ratio, relative
  risk
...
- **Cohen’s d**: Direct standardized effect (0.2 = small, 0.5 = medium,
  0.8 = large)
...
Generate a report documenting your power analysis in text or HTML
format.
...
| Function | Purpose |
|:---|:---|
| [`launch_zzpower()`](https://rgt47.github.io/zzpower/reference/launch_zzpower.md) | Launch interactive Shiny app |
...
This architecture enables support for 20+ statistical tests with minimal
code duplication.
